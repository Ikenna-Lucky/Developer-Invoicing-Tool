        ...
        <div className="max-h-[420px] overflow-y-auto">
          {flat.length === 0 ? (
            ...
            groups.map((group, gi) => {
              ...
              return (
                <div key={group.title}>
                  <p className="px-5 pt-4 pb-2 text-[11px] font-bold text-white/20 uppercase tracking-[0.14em]">
                    {group.title}
                  </p>
                      ...
                      >
                        ...
                        >
                          <Icon
                            size={15}
                            style={{
                              color: item.iconColor ?? "rgba(255,255,255,0.4)",
                            }}
                          />
                        </div>
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-[14px] font-semibold text-white/85 leading-tight">
                            {item.label}
                          </p>
                          {item.sublabel && (
