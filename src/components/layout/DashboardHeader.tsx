...
import {
  Search, LogOut, Settings, ChevronDown,
...
function HeaderSearch() {
  ...
  const QUICK_ACTIONS: CommandItem[] = [
    {
      ...
      sublabel: "Create a blank invoice", icon: Plus, iconColor: "#60a5fa",
      action: () => navigate("/invoices/create"),
      keywords: "create add invoice",
    },
    {
      id: "add-client", type: "action", label: "Add client",
      sublabel: "Register a new client", icon: Users, iconColor: "#a78bfa",
  ...
  return (
    <div ref={containerRef} className="relative flex-1" style={{ maxWidth: 540 }}>
      ...
      >
        <Search
          ...
          style={{ color: open ? "rgba(255,255,255,0.5)" : "rgba(255,255,255,0.25)" }}
        />
        <input
          ref={inputRef}
          type="text"
          ...
          <div className="max-h-[400px] overflow-y-auto py-2">
            {flat.length === 0 && query.length > 0 ? (
              <div className="py-10 flex flex-col items-center text-center">
                ...
                <p className="text-[13px] text-white/30">No results for &ldquo;{query}&rdquo;</p>
              </div>
            ) : (
              groups.map((group, gi) => {
                    ...
                    {group.items.map((item, ii) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <Icon size={13} style={{ color: item.iconColor ?? "rgba(255,255,255,0.4)" }} />
                          </div>
                          <div className="flex-1 min-w-0">
                            ...
                            {item.sublabel && (
                              <p className="text-[11px] text-white/30 mt-0.5 truncate">{item.sublabel}</p>
                            )}
                          </div>
                          {active && (
                            <kbd
        ...
        >
          ...
          <div className="p-5" style={{ borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
            <div className="flex items-center gap-4">
              <AvatarBubble avatarUrl={avatarUrl} initials={initials} size={52} />
              <div className="min-w-0 flex-1">
                <p className="text-[15px] font-bold text-white truncate">{user?.fullName}</p>
          ...
          <div className="p-2">
            ...
            <button
              ...
              onMouseEnter={(e) => { if (!signingOut) (e.currentTarget as HTMLElement).style.background = "rgba(239,68,68,0.08)"; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.background = "transparent"; }}
            >
              {signingOut
...
export function DashboardHeader() {
  return (
    <header
      className="sticky top-0 z-30 flex items-center gap-4 justify-between px-10 h-[68px]"
      style={{
