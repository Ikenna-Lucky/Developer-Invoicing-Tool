...
const GOOGLE_ERRORS: Record<string, string> = {
  ...
  google_no_code:          "Google did not return an authorisation code. Please try again.",
  ...
  google_unverified_email: "Your Google account's email address is not verified.",
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 my-5">
        ...
        <span className="text-[12px] text-white/30 font-medium">or sign in with email</span>
        <div className="flex-1 h-px" style={{ background: "rgba(255,255,255,0.08)" }} />
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <a href="#" className="text-[13px] text-brand-400 hover:text-brand-300 font-medium transition-colors">
              Forgot password?
            </a>
          </div>
